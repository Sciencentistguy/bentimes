...
std::string tens[] = {"zero", "ten", "twenty", "thirty", "forty", "fifty", "sixty"};
std::string specialCases[] = {"ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"};
...
std::string to(Interval interval) {
    std::string o{"It is "};
...
std::string past(Interval interval) {
    std::string o{"It is "};
...
int main() {
    ...
    std::cout << (getRel() == Relative::TO ? to(interval) : past(interval)) << std::endl;
}
